...
auxg=Gt/3;
auxb=Bt/3;
GradPsp_a=subs(GradPsp_a,[Bsp(1,2) Gsp(1,2) Bps(1,2) Gps(1,2)],[auxb auxg auxb auxg]);
GradPsp_a=subs(GradPsp_a,[Bsp(1,3) Gsp(1,3) Bps(1,3) Gps(1,3)],[auxb auxg auxb auxg]);
